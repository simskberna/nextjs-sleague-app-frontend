...
const Landing: React.FC = () => {
  ...
  return (
    ...
    <Container sx={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',gap:2,my:8}}>
        ...
        <Typography variant='body2'>Dive into the top-performing teams and essential statistics that very soccer enthusiast needs to know.</Typography>
        <Container sx={{display:'flex',alignItems:'center',gap:'2px',my:5}}>
    ...
    <Container sx={{display:'flex',gap:10,justifyContent:'center',alignItems:'center'}}>
